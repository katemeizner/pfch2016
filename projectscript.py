				...
				if event_span != None:	
					...
					if show_title != None:
						...
						if matchcard_span != None:
							...
							all_matches.append({"promotion": promotion['title'], "date": date_field.text, "match type" : matchtypes, "match card" : matchcard_span.text, "event title" : show_title, "location": location_title})
